...
# Uso: curl -sO https://raw.githubusercontent.com/rodrigomo-hub/mercantil-clt-integration/main/instalar.sh && bash instalar.sh

set -e

REPO_URL="https://raw.githubusercontent.com/rodrigomo-hub/mercantil-clt-integration/main"
...
echo ""
echo "Documentação: https://github.com/rodrigomo-hub/mercantil-clt-integration"
